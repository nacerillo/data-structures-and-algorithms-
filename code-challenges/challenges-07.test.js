...
const replaceZeros = (string) => {
  ...
  const regex = /[0]/;
  console.log(string);
  var result = string.replace(regex, "zero");
  console.log(string.replace(regex, "zero"));
  return result;
};
...
const addOne = (arr) => {
  // Solution code here...
  //console.log(arr)
  var results = arr.map((value) => value + 1);
  console.log(results);
  return results;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  var results = arr.map((value) => value + "?");
  //console.log(results);
  return results;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (var x = 0; x < arr.length; x++) {
    results.push(Math.pow(2, arr[x]));
  }
  //var results = arr.map( value => Math.pow(2,value));
  //console.log(results);
  return results;
};
...
const charCode = (arr) => {
  // Solution code here...
  var results = [];
  var converted = arr.join("");
  for (var x = 0; x < converted.length; x++) {
    results.push(converted.charCodeAt(x));
  }
  return results;
};
