...
function transformToLis(obj) {
  ...
  for (const property in obj) {
    ...
    str.push(`<li>${property}: ${obj[property]}</li>`);
  }
  //console.log(str);
  return str;
}
...
const addValues = (arr) => {
  // Solution code here...
  const result = arr.reduce(sumUp, 0);
  //sumUp(1,2);
  // console.log(result);
  return result;
...
function sumUp(accumulator, num) {
...
const addPurchases = (arr) => {
  // Solution code here...
  const result = arr.reduce(sumPrice, 0);
  //sumUp(1,2);
  // console.log(result);
  return result;
};

function sumPrice(accumulator, item) {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const result = arr.reduce(counter);
  // console.log(result);
  return result;
};
...
const returnNames = (arr) => {
  // Solution code here...
  const result = arr.reduce(reduceNames, []);
  return result;
}
//       reducerCallBack(accumulator, currentElementWeAreReducing)
function reduceNames(acc, obj) {
  acc.push(obj.name);
  return acc;
}
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  const output = arr.reduce(reduceChildren, 0);
  return output;
}
function reduceChildren(childCount, personObj) {
